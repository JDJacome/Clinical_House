    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2" style="color: #50b4fb; font-weight: bolder;">Creación de formato</h1>
          ...
          <div class="col mg-5 justify-content-center" style="align-items: center;">
            <div class="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
              <div class="col">
                <div class="card">
                  <div class="card-body">
                    <form class="p-4" method="POST" action="../../controller/gestion/añadir_formato.php">
                      <div class="mg-3">
                        <label class="form-label fs-4">Formato de turno</label>
                        <input type="text" class="form-control" name="formato" autofocus required>
                      </div>

                      <div class="mg-3">
                        <label class="form-label fs-4">Horas</label>
                        <input type="number" class="form-control" name="horas" autofocus required>
                      </div>
