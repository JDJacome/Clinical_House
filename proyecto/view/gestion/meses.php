    ...
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3 sidebar-sticky">
          ...
          <ul class="nav flex-column mb-2">
            <li class="nav-item">
              <a class="nav-link active" href="meses.php">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2" style="color: #50b4fb; font-weight: bolder;">Generación de mes</h1>
          ...
          <div class="col mg-5 justify-content-center" style="align-items: center;">
            <div class="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
              <div class="col">
                <div class="card">
                  <div class="card-body">
                    <form class="p-4" method="POST" action="../../controller/gestion/meses.php">
                      <div class="mg-3">
                        <label class="form-label fs-4">Nombre mes</label>
                        <input type="text" class="form-control" name="nombre" autofocus required>
                      </div>

                      <div class="mg-3">
                        <label class="form-label fs-4">Número de días del mes</label>
                        <input type="number" class="form-control" name="dia" autofocus required>
                      </div>

                      <div class="mg-3">
                        <label class="form-label fs-4">Nombre del día que comienza el mes</label>
                        <input type="text" class="form-control" name="nombre_dia" autofocus required>
                      </div>
