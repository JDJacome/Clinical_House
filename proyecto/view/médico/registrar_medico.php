        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../auxiliares/auxiliares.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2" style="color: #50b4fb; font-weight: bolder;">Registrar Médico</h1>
                            ...
                            <!- Mensaje de cédula no válida-->
                                ...
                                ?>
                                    <div class="alert alert-danger" role="alert">
                                        Los ID del médico deben ser mayores a 8 dígitos!
                                    </div>
                                <?php
                                }
                                ?>
                                ...
                                <!- Fin alertas-->
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
                                        <div class="col">
                                            <div class="card">
                                                <div class="card-body">
                                                    <form class="p-4" method="POST" name="formulario1" action="../../controller/medico/registrar_medico.php">
                                                        <div class="mg-3">
                                                            <label class="form-label fs-4">Cédula</label>
                                                        ...
                                                        <div class="mg-3  fs-4">
                                                            ...
                                                            <input type="text" class="form-control" name="especialidad" autofocus required>
                                                        </div>

                                                        <div class="mg-3  fs-4">
                                                            <label class="form-label">Tipo_Contrato</label>
                                                            <input type="text" class="form-control" name="contrato" autofocus required>
                                                        </div>


                                                        <div class="mg-3">
                                                            <label class="form-label fs-4">Seleccione el formato de Módulo</label>

                                                            <select class="form-control" name="modulo" >
                                                                <option value="0">Seleccione
                                                                </option>
                                                                <option value="ATD">ATD
                                                                </option>
                                                                <option value="IRC">IRC
                                                                </option>
                                                            </select>
